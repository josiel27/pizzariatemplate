...
(function() {
  var x = document.getElementById("imgPizza4");
  x.addEventListener("mouseover", mouseover);
  x.addEventListener("mouseout", ouseout);
  ...
  function mouseover() {
    var x = document.getElementsByClassName("w3-display-topleft");
    x[3].style.width = "100%";
    x[3].style.borderTopRightRadius = "2px";
  }

  function ouseout() {
    var x = document.getElementsByClassName("w3-display-topleft");
    x[3].style.width = "50%";
    x[3].style.borderTopRightRadius = "0px";
  }
})();
...
(function() {
  ...
  function mouseover() {
    var x = document.getElementsByClassName("w3-display-topleft");
    x[4].style.width = "100%";
    x[4].style.borderTopRightRadius = "2px";
  }

  function ouseout() {
    var x = document.getElementsByClassName("w3-display-topleft");
    x[4].style.width = "50%";
    x[4].style.borderTopRightRadius = "0px";
  }
})();
...
(function() {
  ...
  function mouseover() {
    var x = document.getElementsByClassName("w3-display-topleft");
    x[5].style.width = "100%";
    x[5].style.borderTopRightRadius = "2px";
  }

  function ouseout() {
    var x = document.getElementsByClassName("w3-display-topleft");
    x[5].style.width = "50%";
    x[5].style.borderTopRightRadius = "0px";
  }
})();
...
(function() {
  ...
  function mouseover() {
    var x = document.getElementsByClassName("w3-display-topleft");
    x[6].style.width = "100%";
    x[6].style.borderTopRightRadius = "2px";
  }
